					...
					<form onSubmit={ handleSubmit }>
						<div className='form-group'>
							<div className='form-label'>
								...
								{(details.name === "" && empty === true) ? <div className='error-message'>*</div> : ""}
							</div>
							<div className="form-input">
								<input
									...
									value={details.name}
									className={(errorMessage !== "") ? 'error-border' : 'default-border'}
								/>
							</div>
						</div>
						...
						<div className='form-group'>
							<div className='form-label'>
								...
								{(details.phone === "" && empty === true) ? <div className='error-message'>*</div> : ""}
							</div>
							<div className={(errorMessage !== "") ? 'error-border' : 'default-border'}>
								<Input 
									type="text"
						...
						<div className='form-group'>
							<div className='form-label'>
								...
								{(details.email === "" && empty === true) ? <div className='error-message'>*</div> : ""}
							</div>
							<div className="form-input">
								<input
									type="text"
									...
									value={details.email}
									className={(errorMessage !== "" || details.email.includes("@")) ? "error-border" : "dafault-border"}
								/>
							</div>
						</div>
						...
						<div className='form-group'>
							<div className='form-label'>
								...
								{(details.password === "" && empty === true) ? <div className='error-message'>*</div> : ""}
							</div>
							<div className="form-input">
								<input
									...
									className={(errorMessage !== "") ? 'error-border' : 'default-border'}
								/>
								<img src={showPassword ? eyeActive : eyeDisabled} alt="show button" className='button show-button' onClick={() => setShowPassword(!showPassword)}/>
							</div>
						</div>
						...
						<div className='form-group'>
							<div className='form-label'>
								...
								{(details.passwordConf === "" && empty === true) ? <div className='error-message'>*</div> : ""}
							</div>
							<div className="form-input">
								<input
									...
									className={(errorMessage !== "") ? 'error-border' : 'default-border'}
								/>
								<img src={showPasswordConf ? eyeActive : eyeDisabled} alt="show button" className='button show-button' onClick={() => setShowPasswordConf(!showPasswordConf)}/>
							</div>
						</div>
