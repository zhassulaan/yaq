	...
	const handleToggle = () => {
  	...
  	return (
		<ul className={isActive ? 'footer-menu footer-close' : 'footer-menu footer-open'}>
			...
			<li className='footer-item' onClick="window.location.reload()">
				<Link to="/products/clothes" className='footer-link'>Одежда</Link>
			</li>
			<li className='footer-item' onClick="window.location.reload()">
				<Link to="/products/clothes/shoes" className='footer-link'>Обувь</Link>
			</li>
			<li className='footer-item' onClick="window.location.reload()">
				<Link to="/products/equipment" className='footer-link'>Снаряжение</Link>
			</li>
			<li className='footer-item' onClick="window.location.reload()">
				<Link to="/products/accessories" className='footer-link'>Аксессуары</Link>
			</li>
			<li className='footer-item' onClick="window.location.reload()">
				<Link to="/products/run" className='footer-link'>Бег</Link>
			</li>
		</ul>
  	);
}
