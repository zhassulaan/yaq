	 	...
	 	<Wrapper>
			...
			{cart.length > 0 ? (
				<div className='section-content'>
					<div className='form-content'>
						...
						<div className="form-comment form-box">
							...
							<textarea name="comment" id="comment" cols="30" rows="10" placeholder='Напишите, что Вы хотите добавить'></textarea>
						</div>
						...
						<p className='term-of-use'>Подтверждая заказ вы соглашаетесь с <a href="/term_of_use">пользовательским соглашением</a></p>
					</div>
				...
				<div className='section-content none'>
					<p className='section-text'>Спасибо! Ваш заказ принят!<br/>Скоро мы свяжемся с Вами по телефону</p>
